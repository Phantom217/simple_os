...
target/kernel.bin: target/multiboot_header.o target/boot.o src/asm/linker.ld cargo
		ld -n -o target/kernel.bin -T src/asm/linker.ld target/multiboot_header.o target/boot.o target/x86_64-unknown-simple_os-gnu/release/libsimple_os.a
...
cargo:
		xargo build --release --target x86_64-unknown-simple_os-gnu
